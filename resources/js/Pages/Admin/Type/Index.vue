...
watch(search, (value) => {
    router.get('/admin/types', { q: value }, { preserveState: true, replace: true })
});
            ...
            <div class="w-full mb-1">
                ...
                <div class="sm:flex">
                    <div
                        ...
                        <div class="lg:pr-3">
                            <label for="types-search" class="sr-only">Search</label>
                            <div class="relative mt-1 lg:w-64 xl:w-96">
                                <input v-model="search" type="text" name="email" id="types-search"
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                ...
                                <tr v-for="type in props.types.data" :key="type.id"
                                    ...
                                    <td
                                        ...
                                        {{ type.name }}</td>
                                    <td
                                        class="p-4 text-base font-medium text-gray-600 whitespace-nowrap dark:text-white">
                                        {{ type.slug }}</td>
                                    <td
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6">
                                    <label for="name"
                                        ...
                                        Name</label>
                                    <input type="text" v-model="formType.name" id="name"
